...
This guide will walk you through the process of setting up the Booking App on your local machine.
...
1. **Environment Files**: Navigate to the `backend` folder and create two files: `.env` and `.env.e2e`. Add the following keys and values to both files:
